...
const int B1_ACCT_ERROR_INVALID = EINVAL;
const int B1_ACCT_ERROR_OOM = ENOMEM;
const int B1_ACCT_ERROR_USER_QUOTA = EDQUOT;
const int B1_ACCT_ERROR_ACTOR_QUOTA = EXFULL;
